---
slug: rental-property-investing-basics
title: "Rental Property Investing Basics: The Numbers That Matter"
description: A beginner's guide to judging a rental property — cap rate, cash flow, cash-on-cash return, the expenses rookies forget, and where the real returns come from.
date: 2026-07-20
---
Rental property can build serious wealth, but it's also where enthusiastic beginners lose money by falling in love with a house instead of analyzing a deal. Real estate investing is a numbers game first and a property second. Here are the fundamentals that separate a good rental from a money pit.

## The four numbers that judge a deal

Professional investors screen rentals on a handful of metrics, all of which our [rental property calculator](/calculators/rental-property-calculator/) computes for you:
...
This combination is why real estate builds wealth — but it's also why it's more work and less liquid than [index fund](/articles/index-funds-explained/) investing. You're effectively running a small business.
