...
description: Rules of thumb, the real math behind retirement targets, and how to turn a scary abstract goal into a monthly number you can actually act on.
date: 2026-07-20
---
...
- **Subtract other income first.** If a pension or Social Security will cover $20,000 of your $40,000 need, your portfolio only has to supply $20,000 — so you need 25 × $20,000 = $500,000, not $1 million. Guaranteed income streams dramatically lower the target.
- **Retiring early?** A 40-year retirement is riskier than a 30-year one, so many early retirees use a more conservative 3–3.5% withdrawal (about 28–33x spending).
...
1. **Estimate your retirement spending** (start with 80% of today's, adjust for your plans).
2. **Multiply by 25** for your portfolio target, minus 25× any pension/Social Security income.
3. **Work out the monthly contribution** that gets you there. Our [retirement savings calculator](/calculators/retirement-savings-calculator/) projects your balance and required contributions; the [401(k)](/calculators/401k-calculator/) and [Roth IRA](/calculators/roth-ira-calculator/) calculators handle the tax-advantaged accounts where most of this should live.
4. **Stress-test the spending phase** with the [retirement withdrawal calculator](/calculators/retirement-withdrawal-calculator/) to see how long the money lasts.
...
- **Mind inflation.** A million dollars decades away buys far less than today. Plan in today's-money terms using a real (inflation-adjusted) return of 4–5% rather than a nominal 7% — see our [real return calculator](/calculators/real-return-calculator/).
