...
title: "What to Do With a Windfall: Bonus, Inheritance, or Lump Sum"
description: A calm, step-by-step plan for handling a sudden sum of money — from a bonus to an inheritance — so it builds lasting wealth instead of vanishing.
date: 2026-07-20
---
...
- **Lifestyle inflation overnight.** A big purchase (luxury car, bigger house) doesn't just spend the windfall — it raises your *ongoing* costs, which can outlast the money and leave you worse off. See [lifestyle creep](/articles/lifestyle-creep).
...
Once you've paused, run the windfall through a priority sequence — essentially the [financial order of operations](/articles/financial-order-of-operations/) applied to a lump sum:

1. **Clear high-interest debt.** Paying off credit cards or other expensive debt is a guaranteed, high, risk-free return — almost always the first move. If several debts compete for the lump, the [avalanche ordering](/calculators/debt-snowball-vs-avalanche-calculator/) settles which goes first.
2. **Build or top up your emergency fund** to 3–6 months of expenses, so you're never forced into debt by a surprise.
3. **Invest the bulk for the long term.** After debt and safety net, the biggest wealth-building use is investing in low-cost [index funds](/articles/index-funds-explained/). A large lump sum invested and left to compound can be genuinely life-changing — see the [future value calculator](/calculators/future-value-calculator/). (Statistically, investing a lump sum all at once usually beats spreading it out, though [dollar-cost averaging](/articles/dollar-cost-averaging-explained/) in over a few months can ease the psychology.)
4. **Fund specific goals** — a house down payment, education, or paying down a low-rate mortgage. (If the mortgage move appeals but monthly cash flow is the real pressure, a [recast](/calculators/mortgage-recast-calculator/) converts the same lump into a permanently lower payment for a ~$250 fee — often the better fit for a windfall than plain prepayment. And if you give to charity, [bunching the gift](/calculators/charitable-donation-bunching-calculator/) into the windfall's high-income year multiplies its tax value.)
