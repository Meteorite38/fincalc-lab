---
slug: sinking-funds-saving-for-big-purchases
title: "Sinking Funds: The Simple Trick for Big Expenses"
description: How sinking funds turn irregular, budget-wrecking expenses into small predictable monthly savings — and why they beat relying on your emergency fund.
date: 2026-07-20
---
...
1. **List your known irregular expenses** and their rough cost and timing.
2. **Divide each by the months until due** to get a monthly contribution. Our [savings goal calculator](/calculators/savings-goal-calculator/) does this for larger targets, and the [down payment calculator](/calculators/house-down-payment-calculator/) handles the biggest sinking fund of all — a home deposit.
...
- **Emergency fund:** for the *unpredictable* (job loss, medical). Kept fully liquid, not spent on planned costs.
- **Sinking funds:** for the *predictable-but-irregular* (annual bills, known repairs, big planned buys). Also liquid, and actively spent down and refilled.
- **Investments:** for the *long-term* (retirement, wealth). Left to compound.
